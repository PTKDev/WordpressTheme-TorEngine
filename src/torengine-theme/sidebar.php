...
?>
	...
	<div id="content">	
		...
		<div class="sid_line"></div><br /> 
			&bull; <a class="bold" href='javascript: apri_menu("menu0")'>Avvisi Importanti</a>
			<div id='menu0' style="display: none;">
			&raquo; <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/avvisi-connettersi-in-wifi/">Connettersi In WiFi</a><br />
			&raquo; <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/avvisi-tessera-mensa/">Tessera Mensa</a><br />
			&raquo; <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/avvisi-esami-facoltativi/">Esami Facoltativi</a><br />
		</div><br /> <br /> 
